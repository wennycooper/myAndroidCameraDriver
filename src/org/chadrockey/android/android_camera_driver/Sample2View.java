...
class Sample2View /*extends SampleCvViewBase*/ {
    ...
    */
	...
	//Bitmap bmp = BitmapFactory.decodeResource(Resources.getSystem(), R.drawable.face1);
...
*/
	...
	public void myProcessFrame()
	{

		Bitmap bbmp = BitmapFactory.decodeResource(mContext.getResources(), R.drawable.face2);
		...
		rawImage.setWidth(bbmp.getWidth());
		rawImage.setHeight(bbmp.getHeight());
		...
		stream.buffer().writeBytes(bb.array());  // bb to stream.buffer
		bb.clear();
